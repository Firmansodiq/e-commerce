  ...
  <section class="flex justify-center py-10">
    <div class="w-[500px]">
      ...
      <form @submit.prevent="submitCategory">
        ...
        <button
          type="submit"
          class="border border-gray-300 text-gray-900 bg-primary hover:bg-primary/80 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
        >
          Submit
        </button>
      </form>
